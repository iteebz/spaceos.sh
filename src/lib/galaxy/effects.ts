...
export const drawNebula = (ctx: CanvasRenderingContext2D, state: GalaxyState) => {
  ...
  const ny = centerY + Math.sin(t * NEBULA.driftYSpeed) * height * NEBULA.driftY
...
export const drawVignette = (ctx: CanvasRenderingContext2D, state: GalaxyState) => {
